...
func (c *Callback) ID() int            { return c.id }
func (c *Callback) Func() CallbackFunc { return c.callback }
...
func (m *Manager) AddOneShotCallback(name string, callback CallbackFunc, concurrent bool) int {
	id := 0
